 ...
 * Let's say, this is part of a JavaScript project that we're tyring to cenvert to TypeScript.
 ...
 * But what if we tons of errors of this kind. We don't want to go to every function, and explicitly
 * annotate various parameters with any.
